	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				//  2: a period, minus signs, or underscore that transitions to state 2 
			...
			case 2: 
				// State 2 deals with a character after a period, minus signs, or underscore in the name.
		...
		case 1:
			...
			if (userNameSize > 16) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName may only contain the characters A-Z, a-z, 0-9, period, minus sign, and underscore.\n";
				return userNameRecognizerErrorMessage;
			}
